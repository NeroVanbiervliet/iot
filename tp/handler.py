...
class SCTransactionHandler:
    ...
    def apply(self, transaction, state):
        ...
        # NERO: _unpack_transaction geeft de appropriate handler functie terug
...
def _update_properties(payload, signer, timestamp, state):
    ...
    * Check that the types are correct
    '''
    # Check that the record is not final
    # NERO: veel netter dan in nodejs processor: binaire data is omgezet naar iets leesbaars
    record_id = payload.record_id
    ...
    for update in updates:
        ...
        # NERO: stuff wordt in pagina's opgeslagen?
